...
class MarcoRebote extends JFrame{
    ...
    public MarcoRebote(){
        ...
        arranca1.addActionListener(new AbstractAction() {
        ...
        arranca2.addActionListener(new AbstractAction() {
            public void actionPerformed(ActionEvent evento) {
                comienza_el_juego(evento);
            }
        });
        ...
        arranca3.addActionListener(new AbstractAction() {
            public void actionPerformed(ActionEvent evento) {
                comienza_el_juego(evento);
            }
        });
        ...
        detener1.addActionListener(new AbstractAction() {
            public void actionPerformed(ActionEvent evento) {
                detener(evento);
            }
        });
        ...
        detener2.addActionListener(new AbstractAction() {
            public void actionPerformed(ActionEvent evento) {
                detener(evento);
            }
        });
        ...
        detener3.addActionListener(new AbstractAction() {
            public void actionPerformed(ActionEvent evento) {
                detener(evento);
            }
        });
